...
String ImprovSerial::get_ssid() { return String(this->command_.ssid.c_str()); }

String ImprovSerial::get_password() { return String(this->command_.password.c_str()); }

String ImprovSerial::get_slack() { return String(this->command_.slack.c_str()); }

int ImprovSerial::available_() { return this->hw_serial_->available(); }
...
std::vector<uint8_t> ImprovSerial::build_version_info_() {
  std::vector<String> infos = {this->firmware_name_, this->firmware_version_, this->hardware_variant_,
                               this->device_name_};
...
ImprovSerial instance;  // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
